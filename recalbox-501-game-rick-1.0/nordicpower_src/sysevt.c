...
typedef enum
{
    ...
    SDL_CONTROLLER_BUTTON_GUIDE=8,
    SDL_CONTROLLER_BUTTON_START=9,
    SDL_CONTROLLER_BUTTON_5=4,
    SDL_CONTROLLER_BUTTON_6=5,
    SDL_CONTROLLER_BUTTON_7=6,
    SDL_CONTROLLER_BUTTON_8=7
  ...
  case SDL_JOYBUTTONDOWN:
  	...
  	switch (event.jbutton.button){
    	...
    	case SDL_CONTROLLER_BUTTON_GUIDE:
    		...
    		break;
#ifdef ENABLE_CHEATS
    	case SDL_CONTROLLER_BUTTON_5:
    		game_toggleCheat(1);
    		break;
    	case SDL_CONTROLLER_BUTTON_6:
    		game_toggleCheat(2);
    		break;
    	case SDL_CONTROLLER_BUTTON_7:
    		game_toggleCheat(3);
    		break;
    	case SDL_CONTROLLER_BUTTON_8:
    		break;
#endif
    }
  	break;
